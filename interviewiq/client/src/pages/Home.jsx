...
// import { BsRobot, BsMic, BsClock, BsBarChart,BsFileEarmarkPdf,BsFileEarmarkText} from "react-icons/bs";
...
//           </div>
//           <p
//             className={`text-xs font-semibold uppercase tracking-wide mb-2 ${item.color.split(" ")[0]}`}
//           >
//             {item.step}
//           </p>
...
//       transition={{ duration: 0.8 }}
//       viewport={{ once: true }}
//       className="font-semibold text-4xl mb-16 transition"
//     >
//       Advanced AI{" "}
...
//       {
//         image: resumeImg,
//         icon: <BsFileEarmarkText size={28} className="text-green-600" />,
//         title: "Resume based interview",
//         desc: "PROJECT specific questions based on uploaded resumes",
//       },
//       {
//         image: pdfImg,
//         icon: <BsFileEarmarkPdf size={28} className="text-green-600" />,
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl w-full">
          {[
            ...
            },
            {
              ...
              desc: "Basic tones and voice analysisinsights",
            },
            {
              image: confiImg,
              icon: (
