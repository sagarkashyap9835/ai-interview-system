...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-700 bg-green-100 pt-16 pb-16">
      <svg
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-6">
            AI Wardrobe Assistant helps you organize your closet, discover outfit ideas, 
            and get personalized AI fashion recommendations tailored to your style.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            <p>Get the latest fashion tips, AI outfit ideas, and style guides sent weekly to your inbox.</p>
            <div className="flex items-center">
              ...
              />
              <button className="bg-gradient-to-b from-indigo-600 to-indigo-800 hover:from-indigo-700 hover:to-indigo-900 transition px-4 h-11 text-white rounded-r-md">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-6 border-t mt-10 border-slate-300">
        <p className="text-center">
          Copyright 2025 © <a href="/">AI Wardrobe Assistant</a>. All Rights Reserved.
        </p>
